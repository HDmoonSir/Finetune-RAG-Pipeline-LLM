...
from src.data_preprocessing import (
    extract_pdf_text,
    preprocess_with_gemini,
    build_vector_store,
)
from src.utils.config_loader import (
    load_data_preprocessing_config,
    load_vector_store_build_config,
...
def main():
    ...
    parser_extract = subparsers.add_parser(
        "extract-pdf", help="Extract text from a PDF file."
    )
    ...
    parser_extract.add_argument(
        ...
        type=int,
        default=None,
        help="The last page to process (inclusive). Defaults to the last page.",
    )
    parser_extract.add_argument(
        "--output_file",
        type=str,
    ...
    parser_preprocess = subparsers.add_parser(
        "preprocess-gemini", help="Generate a dataset using the Gemini API."
    )
    ...
    parser_build_db = subparsers.add_parser(
        "build-db", help="Build a FAISS vector store."
    )
